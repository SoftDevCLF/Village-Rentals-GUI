...
namespace VillageRentalsGUI.Data
{
    public static class DataLoader
    {
        ...
        public static void LoadAll()
        {
            ...
            // Clear the current in-memory category list and add loaded items
        ...
        public static void SaveAll()
        {
            ...
            JsonStorageServices.SaveToJsonSync(Category.AllCategories, categoryPath);
        ...
        private static void RebuildEquipmentCategoryReferences()
        {
            foreach (var equipment in Equipment.AllEquipment)
            {
                if (equipment.Category != null)
                {
                    ...
                    var matched = Category.AllCategories.FirstOrDefault(c => c.CategoryID == equipment.Category.CategoryID);
